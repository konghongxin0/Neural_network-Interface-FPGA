...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_master_non_sec_p2b_adapter.sv \
  $QSYS_SIMDIR/submodules/soc_system_master_non_sec_b2p_adapter.sv \
  ...
  $QSYS_SIMDIR/submodules/soc_system_master_non_sec_timing_adt.sv \
  ...
  $QSYS_SIMDIR/submodules/soc_system_master_non_sec.v \
