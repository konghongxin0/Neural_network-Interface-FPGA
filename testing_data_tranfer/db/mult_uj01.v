//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=7 LPM_WIDTHB=15 LPM_WIDTHP=22 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_uj01
	...
	assign
		wire_sft10a_in = {w189w, {w189w, {w189w, {w189w, {w189w, {w189w, {w189w, {w189w, {w189w, {w189w, {w189w, {w189w, {2{w189w}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft5a_in = {w189w, {w189w, {w189w, {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[35], {w_sum_node10w[34], {2{w189w}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w189w, {w_sum_node10w[33], {w_sum_node10w[32], {w_lone_sum_node11w[10], {w_lone_sum_node11w[9], {w_lone_sum_node11w[8], {w_lone_sum_node11w[7], {w_lone_sum_node11w[6], {w_lone_sum_node11w[5], {w_lone_sum_node11w[4], {w_lone_sum_node11w[3], {w_lone_sum_node11w[2], {w_lone_sum_node11w[1:0]}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w189w, {w189w, {w189w, {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37:36]}}}}}}}}}}}}};
	assign
		dataa_node = {datab[14:0]},
		datab_node = {dataa[6:0]},
		final_result_node = {w330w[21:0]},
		result = {final_result_node[21:0]},
		w189w = 1'b0,
		w330w = {wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[14:0]} & {15{w_le_datab_node8w[6]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[5]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[4]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[3]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[2]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[1]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[6:0]},
		w_lone_sum_node11w = {w_decoder_node9w[104:90]},
		w_sum_node10w = {wire_sum_adder1aa_2result[15:0], w_decoder_node9w[60], wire_sum_adder1aa_1result[15:0], w_decoder_node9w[30], wire_sum_adder1aa_0result[15:0], w_decoder_node9w[0]};
endmodule //mult_uj01
//VALID FILE
